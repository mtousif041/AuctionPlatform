...
const UpcomingAuctions = () => {
  ...
  const today = new Date(); // isse hum aaj ki date nikal lenge
  const todayString = today.toDateString(); // ab isko string me change kr lunga

  // ab muje vo auction chaiye jinhe aaj list hona hai , yaani aaj start hona hai ya start ho gya ho
  const auctionsStartingToday = allAuctions.filter((item) => {
    const auctionDate = new Date(item.startTime); // isse hum date me convert krnege kyunki humne databasae me string format me save kiya hai
