...
const SubmitCommission = () => {
  ...
  const proofHandler = (e) => {
    // proof Handler means ek image handler
    const file = e.target.files[0]; // e.target.files ke zero index pr jo file hai vo muje chaiye
    setProof(file); // yaani setProof ke ander ab mene us file ko set krva diya
  };
  ...
  const handlePaymentProof = (e) => {
    ...
    dispatch(postCommissionProof(formData)); // postCommissionProof me bhej dhenge formData ko
  };
        ...
        <div className="bg-white mx-auto  w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                type="file" // hume sayed se file input ke ander value={} nhai deni rheti hai ekbaar sub project ya sub file me chek krle
