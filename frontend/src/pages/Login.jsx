...
const Login = () => {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      // agr user authenticated hua means ki agr user phele se hi login hai to usko bhej dena hai home page pr
      navigateTo("/");
    }
  }, [dispatch, isAuthenticated, loading]); /// jab jab ye value chaange hogi tab tab ye useeffect run hoga
