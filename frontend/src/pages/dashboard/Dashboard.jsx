...
const Dashboard = () => {
  ...
  }, [isAuthenticated]); // yaani jese hi isAuthenticated ki value change ho to ye krna hai , yaani jab logout / login hoga to isAuthenticated ki value change hogi
        ...
        <>
          <div className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col gap-10">
            ...
            <div className="flex flex-col  gap-10">
              ...
              <div>
                <h3 className="text-[#111] text-xl mb-2 font-semibold  min-[480px]:text-xl md:text-2xl lg:text-3xl">
