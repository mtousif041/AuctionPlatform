...
const CreateAuction = () => {
  ...
  // aap artical ya section khuch bhi use kr shakte ho
  return (
        ...
        >
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <div className="flex flex-col sm:flex-1">
              ...
              <DatePicker // ye react ka build in function hai
                selected={startTime} // selected ka matlab ye hai ki  iski value kiya hogi
                onChange={(date) => setStartTime(date)}
                showTimeSelect // yaani vo time bhi show kro jo apne select kiya hai
                timeFormat="HH:mm" //matlab phele hours show honge fir minut show honge
                timeIntervals={15} //yaani ab isme 15, 15 minut ka gap aayega means ki kitne kitne minute ka gap hona chaiye time me jese 1:15, 1:30, 1:45, 2:00
