...
const Contact = () => {
  ...
  const handleContactForm = (e) => {
    e.preventDefault();
    setLoading(true); // jab bhi ye function execute hoga to loading ki value krdo true
    ...
    /// starting from 17:00:00
    emailjs   //17:00:00
      .send(
        // ye sub data emailjs pe humne jo account bnaya tha usse liya hai
        "service_yxq82p8", //service id
        "template_ce56tp6", // template id
        templateParams, // ye uper se aane waala data hai
        "mrGnd4UkSeNGaH1K-" // public key of emailjs account
      )
      .then(() => {
