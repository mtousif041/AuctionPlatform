...
const Drawer = ({ setOpenDrawer, openDrawer, id }) => {
  // ye in teen chijo accept krta hai
  const dispatch = useDispatch();
  ...
  return (
    <section
      className={`fixed ${
        openDrawer && id ? "bottom-0" : "-bottom-full" // -bottom-full matlab -100% yaani ye bikul screen ke niche hoga show nhai hoga
      ...
      <div className=" bg-white  h-fit transition-all duration-300 w-full">
        <div className="w-full  px-5 py-8 sm:max-w-[640px] sm:m-auto">
          ...
          <form className="flex flex-col gap-5 my-5">
            ...
            <div>
              <button
                type="button" // iska type agr button nhai krenge to ye bhi ek submit button ke bhehaviour ki traha hi kaam krega
